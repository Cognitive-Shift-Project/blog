<!-- Reference example — not built by Astro. Imports reflect the live src/ structure. -->
---
title: Supercharging your Astro Blog with Reusable MDX Components
description: Discover how to leverage MDX to create a set of stunning, reusable UI components that take your technical writing to the next level.
