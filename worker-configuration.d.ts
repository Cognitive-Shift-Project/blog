/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ae9fa676371bdd474c5d237240eedbb7)
// Runtime types generated with workerd@1.20260421.1 2026-04-17 global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface PreviewEnv {
		ASSETS: Fetcher;
		ENVIRONMENT: "preview";
		VALUE_FROM_CLOUDFLARE: "Hello from Cloudflare (Preview)";
		FLAG_ROBOTS_TXT: "false";
	}
	interface Env {
		ASSETS: Fetcher;
		ENVIRONMENT: "preview" | "production";
		VALUE_FROM_CLOUDFLARE: "Hello from Cloudflare (Preview)" | "Hello from Cloudflare (Production)";
		FLAG_ROBOTS_TXT: "false" | "true";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "VALUE_FROM_CLOUDFLARE" | "FLAG_ROBOTS_TXT">> {}
}
